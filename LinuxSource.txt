    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local function createConfirmationDialog(confirmationConfig)
                -- Create overlay that covers the entire Lib frame
                ...
                -- Disable all UI interactions by setting Active to false on all interactive elements
                ...
                -- Function to re-enable all UI interactions when dialog closes
